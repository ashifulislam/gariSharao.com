@extends('layouts.superAdmin.appSuperAdmin')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('superAdmin.register.submit') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('SuperAdminE-Mail Address') }}</label>
