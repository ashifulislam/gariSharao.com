        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 single-gallery">
                    <a href="{{asset('customer/img/g1.jpg')}}" class="img-gal"><img class="img-fluid" src="{{asset('customer/img/g1.jpg')}}" alt=""></a>
                    <a href="{{asset('customer/img/g4.jpg')}}" class="img-gal"><img class="img-fluid" src="{{asset('customer/img/g4.jpg')}}" alt=""></a>
                </div>
                <div class="col-lg-4 single-gallery">
                    <a href="{{asset('customer/img/g2.jpg')}}" class="img-gal"><img class="img-fluid" src="{{asset('customer/img/g2.jpg')}}" alt=""></a>
                    <a href="{{asset('customer/img/g2.jpg')}}img/g5.jpg" class="img-gal"><img class="img-fluid" src="{{asset('customer/img/g5.jpg')}}" alt=""></a>
                </div>
                <div class="col-lg-4 single-gallery">
                    <a href="{{asset('customer/img/g3.jpg')}}" class="img-gal"><img class="img-fluid" src="{{asset('customer/img/g3.jpg')}}" alt=""></a>
                    <a href="{{asset('customer/img/g6.jpg')}}" class="img-gal"><img class="img-fluid" src="{{asset('customer/img/g6.jpg')}}" alt=""></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-latest-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('customer/img/b1.jpg')}}" alt="">
                        </div>
                        <ul class="tags">
                ...
                <div class="col-lg-6">
                    <div class="single-latest-blog">
                        <div class="thumb">
                            <img class="img-fluid" src="{{asset('customer/img/b2.jpg')}}" alt="">
                        </div>
                        <ul class="tags">
                            <li><a href="#">Travel</a></li>
                            <li><a href="#">Life Style</a></li>
